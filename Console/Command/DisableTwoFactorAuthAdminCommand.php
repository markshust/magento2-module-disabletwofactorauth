...
class DisableTwoFactorAuthAdminCommand extends Command
{
    ...
    public const COMMAND_ADMIN_2FA_DISABLE = 'admin:user:2fa:disable';
    public const COMMAND_DESCRIPTION = 'Disable 2FA for admin';
...
HELP
    ...
    protected function execute(InputInterface $input, OutputInterface $output): void
    {
        ...
        try {
            ...
            $this->disable2FAForAdmin($user);
            $outputMessage = sprintf('2FA disabled for admin "%s"', $adminUserName);
        } catch (Exception $noSuchEntityException) {
            $outputMessage = $noSuchEntityException->getMessage();
        }
     ...
     * @throws Exception
     */
    private function disable2FAForAdmin(User $user): void
    {
        $user->setData(ModifierUserInterface::IS_ENABLE_2FA_AUTH, ModifierUserInterface::FIELD_2FA_DISABLE);
